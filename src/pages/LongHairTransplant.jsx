...
export default function LongHairTransplant() {
  ...
  return (
    <main className="bg-[#FFF8EF] text-[#2B333C] overflow-hidden">
      ...
      <SEO
        title="Long Hair Transplant | No Shave Hair Transplant Results"
        description="Get a long hair transplant without shaving your head. Achieve natural-looking results with advanced techniques and expert-led precision."
