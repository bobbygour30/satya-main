    ...
    <section className="w-full bg-[#2B333C] relative overflow-hidden py-7 px-6">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center mb-24">
        ...
        <p className="text-[#DFDFDD] mt-5 text-base md:text-lg leading-relaxed">
          Trusted by thousands of patients to deliver ethical, medically
          validated, and personalized skin & hair care.
        </p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto bg-[#FFF8EF] rounded-3xl px-6 md:px-10 py-20">
        ...
        <div className="grid md:grid-cols-4 gap-5">
          {[
            {
              title: "Hair Concerns",
              desc: "Androgenetic Alopecia, Female Pattern Hair Loss, Excessive Hair Fall, DHT-Related Hair Loss, Diffuse Hair Thinning, Early Baldness, Genetic Hair Loss, Stress-Induced Hair Loss.",
              bg: "bg-white",
              text: "text-[#2B333C]",
            },
            {
              title: "Hair Treatment",
              desc: "FUE Hair Transplant, Hairline Reconstruction, Beard Hair Transplant, Moustache Hair Transplant, Eyebrow Reconstruction, Afro Hair Transplant, Body Hair Transplant, Hair Transplant Repair.",
              bg: "bg-[#2B333C] text-white",
              text: "text-white",
            },
            {
              title: "Skin Concerns",
              desc: "Acne Scar, Fungal Infection, Aging, Fine lines/wrinkles, Under eye darkening/hollows, Laugh lines, Thin lips, Neck lines, Sagging, Uneven skin tone, Patchy skin, Sensitive skin, Rosacea, Acne, Acne scars, Dull skin, Open pores.",
              bg: "bg-white",
              text: "text-[#2B333C]",
            },
            {
              title: "Skin Treatment",
              desc: "Laser Hair Reduction, Chemical Peel, Mole removal, Laser Toning Treatment, Fractional CO2 Laser, HIFU treatment, MNRF treatment, Botox, Carbon laser facial, Dermapen 4, Anti Wrinkle Treatment.",
            ...
            >
              ...
              <p className="text-sm text-[#828D9C]">{item.desc}</p>
            </motion.div>
          ))}
        </div>

        {/* ===== NEW CONTENT (ABOVE IMAGE SECTION) ===== */}
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="show"
        ...
        >
          <h3 className="text-2xl md:text-3xl font-semibold text-[#2B333C] mb-4">
            Struggling with Hair Loss or Persistent Skin Issues?
          </h3>
          <p className="text-[#828D9C] text-sm leading-relaxed">
            At Satya, we don’t just treat symptoms, we diagnose the root cause and
            build a medical plan that’s right for your condition.
          </p>
        </motion.div>
